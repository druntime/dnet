...
- [Transports](./transports/transports.md)
  ...
  - [Framed](./transports/framed.md)
  - [Length-delimited](./transports/length-delimited.md)
...
- [Remote Procedure Call](./rpc/rpc.md)
  - [API](./rpc/api.md)
  - [Producing](./rpc/producing.md)
  - [Consuming](./rpc/consuming.md)

- [Writing a custom `dnet` transport](./custom-transport.md)
